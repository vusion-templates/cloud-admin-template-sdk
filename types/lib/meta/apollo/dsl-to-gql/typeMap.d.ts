import { GraphQLFieldConfigArgumentMap, GraphQLFieldConfigMap, GraphQLInputFieldConfigMap, GraphQLInputType, GraphQLOutputType, Thunk } from 'graphql';
...
export declare const getTypeFields: ({ jsonSchema, title, isInputType, gqlTypes }: {
    jsonSchema: JSONSchemaType;
    title: string;
    isInputType: boolean;
    gqlTypes: GraphQLTypeMap;
}) => Thunk<GraphQLInputFieldConfigMap> | Thunk<GraphQLFieldConfigMap<any, any>>;
