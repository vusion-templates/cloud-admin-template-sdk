...
exports.generateRandomMutation = exports.generateRandomQuery = exports.generateQueryByField = exports.getTypeName = void 0;
...
function generateQueryByField(schema, config = {
    seed: 0,
    nextSeed: 0,
    nodeFactor: 1,
    typeCount: 0,
    ...
    (node.fields || []).forEach((field) => {
        const fieldname = field.name.value;
        const fieldNodeAst = Object.assign(Object.assign({}, node), { fields: [field] });
        // 单个 field 产生的 query
        const { selectionSet, variableDefinitionsMap, variableValues } = getSelectionSetAndVars(schema, fieldNodeAst, config);
...
exports.generateQueryByField = generateQueryByField;
