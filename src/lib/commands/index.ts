...
export default function (root: string): Command {
  ...
  return {
    ...
    "view.savePartialCode": async function (
      pageName: string,
      viewPath: string,
    ...
    "view.mergeCode": async function (
      pageName: string,
      viewPath: string,
      code: string,
      nodePath: string
    ): ReturnType<View["mergeCode"]> {
      return await project.page
        .load(pageName)
        .view.load(viewPath)
        .mergeCode(code, nodePath);
    },
    "view.addBlock": async function (
      pageName: string,
      viewPath: string,
      blockInfo: BlockInfo
    ): ReturnType<View["addBlock"]> {
      return await project.page
        .load(pageName)
        .view.load(viewPath)
        .addBlock(blockInfo);
    },
    "view.addCustomComponent": async function (
      pageName: string,
      viewPath: string,
      blockInfo: BlockInfo,
      content: string
    ): ReturnType<View["addCustomComponent"]> {
      return await project.page
        .load(pageName)
        .view.load(viewPath)
